...
USERS = [
    {"id": "u001", "name": "Cpl. Sarah Okafor",    "clearance": 1, "dept": "Logistics"},
    {"id": "u002", "name": "Lt. James Hargreaves",  "clearance": 2, "dept": "Intelligence"},
    {"id": "u003", "name": "Maj. Priya Nair",       "clearance": 3, "dept": "Operations"},
    {"id": "u004", "name": "Sgt. Tom Whitfield",    "clearance": 1, "dept": "Communications"},
    {"id": "u005", "name": "Col. Diana Ashworth",   "clearance": 4, "dept": "Command"},
    {"id": "u006", "name": "Pvt. Leon Mensah",      "clearance": 0, "dept": "Admin"},
]

CLEARANCE_LABELS = {0: "UNCLASSIFIED", 1: "RESTRICTED", 2: "SECRET", 3: "TOP SECRET", 4: "COSMIC TOP SECRET"}

FILES = [
    {"name": "logistics_schedule.xlsx",     "clearance": 1},
    {"name": "agent_identities_2024.pdf",   "clearance": 3},
    {"name": "op_nightfall_brief.docx",     "clearance": 3},
