...
class UEBAEngine:
    ...
    def __init__(self):
        ...
        self._fitted = False
        self._history = []          # stores feature vectors for retraining
        self._event_store = []      # all events seen
        self._threat_store = []     # only flagged events
    ...
    def analyse(self, event: dict) -> dict:
        ...
        # Combine: rule hit OR ML flags it as anomalous
        is_threat = rule_hit or ml_score < 0  # IsolationForest: -1 = anomaly
    ...
    def _featurise(self, event):
        ...
        return [
            ...
            event.get("bytes_sent", 0) / 1_000_000,  # normalise to MB
